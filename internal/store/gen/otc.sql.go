...
SELECT id, order_id, product_id, sku, name, quantity, unit, unit_price, tax_amount, row_total, configuration, vendor_id FROM order_items WHERE id = $1 AND order_id = $2
`
