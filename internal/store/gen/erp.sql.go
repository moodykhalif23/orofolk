...
SELECT o.id, o.public_id, o.organization_id, o.website_id, o.customer_id, o.customer_user_id, o.quote_id, o.placed_by_sales_rep_id, o.status, o.currency, o.po_number, o.requested_delivery_date, o.billing_address, o.shipping_address, o.subtotal, o.tax_total, o.shipping_total, o.grand_total, o.created_at, o.updated_at FROM orders o
WHERE o.organization_id = $1
